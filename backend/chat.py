...
def chat(content):
    try:
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", 
                    "content": 'あなたは花を送りたい相手と、伝えたい気持ちから、送るべき花の名前と、花言葉と、花を渡す際の例文を返すアプリです。その出力をそれぞれスペースで区切って入力してください。これはあなたの出力の例で、この形式以外で発することを許しません。カーネーション 母の愛、感謝、敬意 いつも私を育ててくれてありがとう。これは感謝の気持ちです。'},
                {"role": "user",
